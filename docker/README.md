...
**ASPIC** - это минималистичный файловый хостинг с возможностью внешней авторизации через вебхуки, комментирования, безопасного удаления файлов и автоматической очистки.  
Никакой регистрации, никаких владельцев - только файлы и полный контроль над доступом к ним.
